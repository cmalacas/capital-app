...
<html lang="en">
    ...
    <body>
            ...
            <div class="container mb"> 
                <div class="row">
                    <div class="col-md-1 home_logo">
                        <a href="#" rel="home"><img src={{ asset("/registration/img/home-button.jpg") }} class="nav-home-btn"></a>
                    </div>
                    ...
                    <div class="col-md-3 main_logo">
                        <div class="site-branding">
                            <a href="#" rel="home"><img src={{ asset("/registration/img/LOGO.png") }} alt="logo"></a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3 widget-with-bg">
                        <aside id="text-15">
                            <div class="textwidget">
                                <div class="header-one-widget-footer">
                                    <img src={{ asset("/registration/img/footer-logo.png") }} alt="Capital Office">
                                </div>
                        ...
                        <div class="img-wrapper">
                            <img class="widget-one-bg" src={{ asset("/registration/img/footer-widget-bg.png") }} alt="Capital Office">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <aside id="text-17" class="widget widget_text">
                            <div class="textwidget">
                                <h4 class="header-two-footer services h2-heading">Our Main Services</h4>
                            </div>
                        </aside>
                        <aside id="nav_menu-2" class="widget widget_nav_menu">
                            <div class="menu-footer-menu-container">
                                <ul id="menu-footer-menu" class="menu">
                                    <li id="menu-item-77246" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-77246">
                                        <a href="#">Call Answering</a></li>
                                    <li id="menu-item-77247" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-77247">
                                        <a href="#">Company Formations</a></li>
                                    <li id="menu-item-77248" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-77248">
                                        <a href="#">Affordable Business Website Design</a></li>
                                    <li id="menu-item-78096" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-78096">
                                        <a href="#">Complete Virtual Office</a></li>
                                    <li id="menu-item-77250" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-77250">
                                        <a href="#">Meeting Rooms London</a></li>
                                    <li id="menu-item-77251" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-77251">
                                        <a href="#">London Address Services</a></li>
                                </ul>
                            </div>
                        </aside>
                    </div>
                    <div class="col-md-6">
                        <aside id="text-7" class="widget widget_text">
                            <div class="textwidget">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <h4 class="header-two-footer h2-heading">OFFICE HOURS</h4>
                                        <p>Monday to Friday</p>
                                        <p>09.00 a.m. – 17.00 p.m.</p>
                                        <p>Local Time is (GMT)</p>
                                    </div>
                                    <div class="col-md-7">
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 credits-left">
                        © Copyright 2016 Capital Office Ltd | VAT number: 976201416 <br>
                        <a href="/terms-conditions/" title="Terms And Conditions">Terms And Conditions</a> | 
                        <a href="/privacy-policy-capital-office-ltd/" title="GDPR Privacy Policy">GDPR Privacy Policy</a> | 
                        <a href="/terms-of-use/" title="Website Usage Terms">Website Usage Terms</a> | 
                        <a href="/cookie-policy/" title="Cookie Policy">Cookie Policy</a><br>
                        Please <a href="/squatters-illegal-use-of-our-address/" style="text-decoration:underline;">click here</a> to view the latest businesses using our address without authorisation.
                    </div>
                    <div class="col-md-6 badges-footer credits-right">
                        ...
                        <img src={{ asset("/registration/img/badge9.png") }}>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script src={{ asset("/registration/js/bootstrap.min.js") }}></script>
        <script src={{ asset("/registration/js/jquery.bootstrap.wizard.js") }}></script>
    
        <!-- <script src={{ asset("/registration/js/1.js") }}></script> -->
        <script src={{ asset("/registration/js/2.js") }}></script>
